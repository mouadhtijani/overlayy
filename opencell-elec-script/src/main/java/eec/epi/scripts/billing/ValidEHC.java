...
public class ValidEHC extends Script {
    ...
    public void execute(Map<String, Object> context) {
        ...
        if (invoice == null) {
            ...
            for (InvoiceLine invoiceLine : invoice.getInvoiceLines()) {
                if (invoiceLine.getAccountingArticle().getCode().equals("AA_IR_ENER_HC") && invoiceLine.getQuantity().compareTo(new BigDecimal(400)) >= 0) {
