 ...
 */
public class ValidEAN extends Script {
    ...
    public void execute(Map<String, Object> context) {
        ...
        if (invoice == null) {
            ...
            for (InvoiceLine invoiceLine : invoice.getInvoiceLines()) {
                if (invoiceLine.getAccountingArticle().getCode().equals("AA_BVE_EA_NUIT") && invoiceLine.getQuantity().compareTo(new BigDecimal(1000)) >= 0) {
