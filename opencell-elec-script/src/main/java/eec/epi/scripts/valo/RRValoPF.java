...
public class RRValoPF extends RatingScript {
    protected static final String CT_GRILLE_TARIFAIRE = "ct_grille_tarifaire";


    protected static final String CH_RR_BVE_PRIME_FIXE = "CH_RR_BVE_PRIME_FIXE";
    ...
    public void execute(RatingContext ratingContext) {
        ...
        ChargeInstance chargeInstance = ratingContext.getChargeInstance(walletOperation, CH_RR_BVE_PRIME_FIXE);
        ...
        pricePF =ratingContext.reCalculate(pricePF.divide(new BigDecimal(12), 0, RoundingMode.HALF_UP),walletOperation);
        ratingContext.calculate(walletOperation, pricePF, ratingContext.getCf_puissance_souscrite(), OperationTypeEnum.DEBIT, ratingContext.getOFFER(), ratingContext.getPROD());
    }
