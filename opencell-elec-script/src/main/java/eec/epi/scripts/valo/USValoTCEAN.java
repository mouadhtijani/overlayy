 ...
 */
public class USValoTCEAN extends RatingScript {
    protected static final String CH_US_BVE_TAXECOM_EAN = "CH_US_BVE_TAXECOM_EAN";
    ...
    public void execute(RatingContext ratingContext) {
        ...
        ChargeInstance chargeInstance = ratingContext.getChargeInstance(walletOperation, CH_US_BVE_TAXECOM_EAN);
    ...
    private void applyRulesForHTA(RatingContext ratingContext, List<Map<String, Object>> list, Object cf_code_exploitation) {
        ...
        priceEA = ratingContext.getValueFromList(PX_EA_NUIT, ratingContext.getOFFER(), HTA, cf_code_exploitation, list,subscriptionCode);
    }
    private void applyRulesForBT(RatingContext ratingContext, List<Map<String, Object>> list, Object cf_code_exploitation) {
        ...
        priceEA = ratingContext.getValueFromList(PX_EA_NUIT, ratingContext.getOFFER(), BT, cf_code_exploitation, list,subscriptionCode);
    }
