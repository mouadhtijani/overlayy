...
public class USValoTCHP extends RatingScript {

    protected static final String CH_US_IR_TAXECOM_ENER_HP = "CH_US_IR_TAXECOM_ENER_HP";
    ...
    public void execute(RatingContext ratingContext) {
        ...
        ChargeInstance chargeInstance = ratingContext.getChargeInstance(walletOperation, CH_US_IR_TAXECOM_ENER_HP);
    ...
    private void applyRulesForBT(RatingContext ratingContext, List<Map<String, Object>> list, Object cf_code_exploitation) {
        ...
        priceEA = ratingContext.getValueFromList(PX_EA_HP, ratingContext.getOFFER(), BT, cf_code_exploitation, list,subscriptionCode);
    }
