...
public class USValoHC extends RatingScript {


    protected static final String CT_GRILLE_TARIFAIRE = "ct_grille_tarifaire";

    protected static final String CH_US_IR_ENER_HC = "CH_US_IR_ENER_HC";
    ...
    public void execute(RatingContext ratingContext) {
        ...
        ChargeInstance chargeInstance = ratingContext.getChargeInstance(walletOperation, CH_US_IR_ENER_HC);
        ...
        priceEAJ = ratingContext.getValueFromList(PX_EA_HC, ratingContext.getOFFER(), BT, cf_code_exploitation, list, subscriptionCode);
