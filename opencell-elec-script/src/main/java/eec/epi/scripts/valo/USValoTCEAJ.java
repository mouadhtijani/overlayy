 ...
 */
public class USValoTCEAJ extends RatingScript {

    protected static final String CH_US_BVE_TAXECOM_EAJ = "CH_US_BVE_TAXECOM_EAJ";
    ...
    protected static final String BVE_BT = "BVE_BT";
    protected static final String BVE_HTA = "BVE_HTA";
    ...
    public void execute(RatingContext ratingContext) {
        ...
        ChargeInstance chargeInstance = ratingContext.getChargeInstance(walletOperation,CH_US_BVE_TAXECOM_EAJ);
    ...
    private void applyRulesForHTA(RatingContext ratingContext, List<Map<String, Object>> list, Object cf_code_exploitation) {
        ...
        priceEA = ratingContext.getValueFromList(PX_EA_JOUR, ratingContext.getOFFER(), HTA, cf_code_exploitation, list,subscriptionCode);
    }
    private void applyRulesForBT(RatingContext ratingContext, List<Map<String, Object>> list, Object cf_code_exploitation) {
        ...
        priceEA = ratingContext.getValueFromList(PX_EA_JOUR, ratingContext.getOFFER(), BT, cf_code_exploitation, list,subscriptionCode);
    }
