...
COLLECTION="$SCRIPT_DIR/epi-roles-release-full.postman_collection.json"
#ENVIRONMENT="$SCRIPT_DIR/localhost.postman_environment.json"
ENVIRONMENT="$SCRIPT_DIR/../env/devops.postman_environment.json"
REPORT_FOLDER="$SCRIPT_DIR/reports"
HTML_REPORT="$REPORT_FOLDER/reportLast.html"
JSON_REPORT="$REPORT_FOLDER/reportLast.json"
